...
const extraSelectFields = [
  ...
  { id: "pessoas", label: "Pessoas no financeiro", options: ["Somente eu", "1 pessoa dedicada", "2 a 3 pessoas", "4 ou mais"] },
  { id: "ferramenta", label: "Ferramenta principal", options: ["Planilhas Excel / Google Sheets", "ERP (Omie, Bling, Totvs, SAP...)", "Sistema próprio", "Nenhum sistema estruturado"] },
];
...
const DiagnosticForm = () => {
      ...
      <div className="flex flex-col items-center justify-center py-14 px-6 text-center gap-6">
        ...
        <div>
          ...
          <p className="font-body text-sm text-body max-w-md leading-relaxed">
            A equipe da BPOn vai analisar as informações e entrar em contato. Em geral respondemos em até 1 dia útil.
          </p>
        </div>
      </div>
    );
  ...
  const inputClass = "w-full px-4 py-3 rounded-lg border font-body text-sm text-headline placeholder:text-body/45 focus:outline-none focus:ring-2 transition-all duration-200"
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <div className="flex items-center gap-2 mb-1">
        {[1, 2].map((s) => (
          <div key={s} className="flex items-center gap-2">
            ...
            <span className={`font-body text-[11px] ${step === s ? "text-headline font-medium" : "text-body/60"}`}>
        ...
        <div className="flex flex-col gap-4 animate-fade-in">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input id="whatsapp" type="tel" placeholder="(34) 99999-9999"
      ...
      {step === 2 && (
        <div className="flex flex-col gap-4 animate-fade-in">
          ...
          {/* Faturamento */}
          <div className="flex flex-col gap-1.5">
            <label htmlFor="faturamento" className="font-body text-xs font-semibold text-headline">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea id="desafio" rows={3} required
          ...
          <div className="rounded-lg border border-divider overflow-hidden">
            <button type="button"
              ...
              <span className="font-body text-xs font-medium text-body group-hover:text-headline transition-colors duration-200">
                Informações complementares <span className="text-body/45 font-normal">(opcional)</span>
              </span>
            ...
            {showExtra && (
              <div className="px-4 pb-4 pt-3 flex flex-col gap-4 border-t border-divider bg-surface/50">
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="cidade" className="font-body text-xs font-medium text-headline">Cidade / UF</label>
                  <input id="cidade" type="text" placeholder="Uberlândia / MG"
                    value={form["cidade"] || ""}
          ...
          <label className="flex items-start gap-3 cursor-pointer group">
            <div className="relative mt-0.5 flex-shrink-0">
              ...
              <div className={`w-4 h-4 rounded border flex items-center justify-center transition-all duration-200 ${
                lgpdAccepted ? "bg-primary border-primary" : "bg-white border-divider group-hover:border-primary/40"
              }`}>
                {lgpdAccepted && (
