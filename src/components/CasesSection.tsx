  ...
  return (
    <section id="casos" className="py-20 lg:py-28 bg-background">
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3.5">
          {cases.map((c, i) => {
            ...
            return (
              ...
              >
                {/* Card header */}
                <div className="px-5 pt-5 pb-4 border-b border-divider flex items-center gap-3">
                  <div className="icon-sm icon-bg">
                ...
                <div className="flex flex-col gap-4 p-5 flex-1">
                  <div>
                    <p className="font-body text-[10px] font-semibold text-muted-foreground uppercase tracking-[0.10em] mb-1.5">Situação</p>
                    <p className="font-body text-[12.5px] text-body leading-relaxed">{c.situation}</p>
                  </div>
                  <div>
                    <p className="font-body text-[10px] font-semibold text-primary/55 uppercase tracking-[0.10em] mb-1.5">O que foi feito</p>
                    <p className="font-body text-[12.5px] text-body leading-relaxed">{c.action}</p>
                  </div>
                  <div className="mt-auto pt-4 border-t border-divider">
                    <p className="font-body text-[10px] font-semibold text-headline/55 uppercase tracking-[0.10em] mb-1.5">Resultado</p>
        ...
        <p className="mt-4 font-body text-[11px] text-muted-foreground reveal reveal-delay-4">
